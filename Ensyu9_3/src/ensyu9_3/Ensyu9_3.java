...
public class Ensyu9_3 {
	...
	/*
	 * 関数名：main
	 * 概要：銀行口座クラスに口座開設日のフィールドとtoStringメソッドを追加する
	 * 引数：なし
	 * 戻り値：なし
	 * 作成者：R.Sugihara
	 * 作成日：2023.05.10
	...
	public static void main(String[] args) {
		...
		//変数inputNoを生成し、文字列を読み込む
		String inputNo = standardInput.next();
		//預金残高の入力を促す
		System.out.print("預金残高：");
		//変数inputBalanceを生成し、メソッドplusNumberで入力を行う
		long inputBalance = plusNumber();
		//口座開設日の入力を促す
		...
		Account myAccount = new Account(inputName, inputNo, inputBalance, new Day(inputYear, inputMonth, inputDay));
		//myAcoountの内容を表示する
